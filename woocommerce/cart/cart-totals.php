...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
    ...
    <div class="u-align-right u-cart-block-content u-text">
              ...
              <a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="u-border-2 u-border-black u-btn u-button-style u-cart-checkout-btn u-hover-black u-none u-text-black u-text-hover-white u-btn-4"><?php esc_html_e( 'Proceed to checkout', 'woocommerce' ); ?></a>
            </div>
