...
<?php $skip_min_height = false; ?><section class="u-clearfix u-image u-section-1" id="sec-8787" data-image-width="320" data-image-height="200" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/Holographic2.png');">
  <div class="u-clearfix u-sheet u-sheet-1">
    <div class="u-cart u-cart-1">
            ...
            <?php
		                ...
		                foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ):
			                ...
			                if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ):
				                ...
				                if ($itemIndex % 2 === 0): ?><tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>" style="height: 121px;">
      ...
      <div class="u-cart-button-container">
        ...
        <a href="#" class="u-border-2 u-border-black u-btn u-button-style u-cart-update u-hover-black u-none u-text-black u-text-hover-white u-btn-2"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></a>
      </div>
              ...
              <div class="u-cart-form u-form">
                <form action="#" method="POST" class="u-clearfix u-form-horizontal u-form-spacing-10 u-inner-form" source="custom" name="form">
                  ...
                  <div class="u-align-left u-form-group u-form-submit">
                    <a href="#" class="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-3"><?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?></a>
