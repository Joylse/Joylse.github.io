<?php $skip_min_height = false; ?><section class="u-align-center u-clearfix u-section-1" id="sec-20da">
        ...
        <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1"><!--product_image-->
          ...
          <div class="u-product-control u-product-price u-product-price-1">
            <div class="u-price-wrapper u-spacing-10"><!--product_old_price-->
              <div class="u-hide-price u-old-price"><?php echo wc_price($product->get_regular_price()); ?></div><!--/product_old_price--><!--product_regular_price-->
              <div class="u-price u-text-palette-2-base" style="font-size: 1.25rem; font-weight: 700;"><?php echo wc_price($product->get_price()); ?></div><!--/product_regular_price-->
            </div>
